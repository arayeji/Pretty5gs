...
- `MME=http://127.0.0.2:9091` — replace with your daemon's metrics URL.
- `SGWC=http://127.0.0.2:9090` — SGWC metrics URL (`sgwc.metrics` in yaml).
- `AMF=http://127.0.0.2:9090`
- `SMF=http://127.0.0.2:9092`
...
```text
[mme] INFO: admin: /admin/enb/detach from 127.0.0.1:54321 (force=0)
...
```text
[mme] INFO: admin: /admin/ue/detach from 127.0.0.1:54322 (force=0)
...
```bash
MME=http://127.0.0.2:9091
SGWC=http://127.0.0.2:9090
SMF=http://127.0.0.2:9092
