...
#define OGS_GTP2_CAUSE_IS_SUCCESS(c) \
    ((c) == OGS_GTP2_CAUSE_REQUEST_ACCEPTED || \
     (c) == OGS_GTP2_CAUSE_REQUEST_ACCEPTED_PARTIALLY || \
     (c) == OGS_GTP2_CAUSE_NEW_PDN_TYPE_DUE_TO_NETWORK_PREFERENCE || \
     (c) == OGS_GTP2_CAUSE_NEW_PDN_TYPE_DUE_TO_SINGLE_ADDRESS_BEARER_ONLY)
